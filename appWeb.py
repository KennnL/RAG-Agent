    ...
    with st.sidebar:
        ...
        if uploaded_file is not None:
            ...
            if st.button("Load Data", type="primary"):
                result = st.session_state.controller.handle_request("load_csv", "temp_upload.csv")
        ...
        if st.button("Use Sample Data"):
            ...
            result = st.session_state.controller.handle_request("load_csv", "sample.csv")
            if result.get('success'):
    ...
    with tab1:
        ...
        with col2:
            if st.button("Insert", type="primary", disabled=not st.session_state.data_loaded):
                if user_input:
                    result = st.session_state.controller.handle_request("insert", user_input)
        ...
        if st.session_state.data_loaded:
            ...
            all_returns = st.session_state.controller.handle_request("query")
            ...
            with col2:
                if st.button("Generate Report", type="primary"):
                    with st.spinner("Generating report..."):
                        result = st.session_state.controller.handle_request("report", report_name)
